...
Grafic1::Grafic1(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic1)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 1");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 1-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/1.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic1::resizeEvent(QResizeEvent *evt)
{
...
void Grafic1::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic1::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic1::on_pushButton_3_clicked()
{
...
void Grafic1::on_pushButton_4_clicked()
{
