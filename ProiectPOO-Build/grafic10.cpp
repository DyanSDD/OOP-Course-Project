...
Grafic10::Grafic10(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic10)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 10");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 10-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/10.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic10::resizeEvent(QResizeEvent *evt)
{
...
void Grafic10::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic10::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic10::on_pushButton_3_clicked()
{
...
void Grafic10::on_pushButton_4_clicked()
{
