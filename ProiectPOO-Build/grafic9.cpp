...
Grafic9::Grafic9(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic9)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 9");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 9-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/9.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic9::resizeEvent(QResizeEvent *evt)
{
...
void Grafic9::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic9::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic9::on_pushButton_3_clicked()
{
...
void Grafic9::on_pushButton_4_clicked()
{
