...
Grafic3::Grafic3(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic3)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 3");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 3-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/3.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic3::resizeEvent(QResizeEvent *evt)
{
...
void Grafic3::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic3::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic3::on_pushButton_3_clicked()
{
...
void Grafic3::on_pushButton_4_clicked()
{
