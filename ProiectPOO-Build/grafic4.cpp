...
Grafic4::Grafic4(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic4)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 4");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 4-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/4.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic4::resizeEvent(QResizeEvent *evt)
{
...
void Grafic4::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic4::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic4::on_pushButton_3_clicked()
{
...
void Grafic4::on_pushButton_4_clicked()
{
