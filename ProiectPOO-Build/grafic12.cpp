...
Grafic12::Grafic12(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic12)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 12");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 12-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/12.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic12::resizeEvent(QResizeEvent *evt)
{
...
void Grafic12::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic12::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic12::on_pushButton_3_clicked()
{
...
void Grafic12::on_pushButton_4_clicked()
{
