...
Grafic7::Grafic7(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic7)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 7");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 7-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/7.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic7::resizeEvent(QResizeEvent *evt)
{
...
void Grafic7::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic7::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic7::on_pushButton_3_clicked()
{
...
void Grafic7::on_pushButton_4_clicked()
{
