...
Grafic8::Grafic8(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic8)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 8");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 8-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/8.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic8::resizeEvent(QResizeEvent *evt)
{
...
void Grafic8::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic8::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic8::on_pushButton_3_clicked()
{
...
void Grafic8::on_pushButton_4_clicked()
{
