...
GraficeGeneral::GraficeGeneral(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::GraficeGeneral)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelare Generala");
    ...
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/general.png";
    char* charVLocation;
    char* charVLocation2;
...
void GraficeGeneral::resizeEvent(QResizeEvent *evt)
{
...
GraficeGeneral::~GraficeGeneral()
{
    delete ui;
}

void GraficeGeneral::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void GraficeGeneral::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void GraficeGeneral::on_pushButton_3_clicked()
{
...
void GraficeGeneral::on_pushButton_4_clicked()
{
