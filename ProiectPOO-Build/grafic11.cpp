...
Grafic11::Grafic11(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic11)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 11");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 11-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/11.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic11::resizeEvent(QResizeEvent *evt)
{
...
void Grafic11::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic11::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic11::on_pushButton_3_clicked()
{
...
void Grafic11::on_pushButton_4_clicked()
{
