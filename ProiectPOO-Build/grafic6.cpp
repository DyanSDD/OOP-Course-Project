...
Grafic6::Grafic6(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic6)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 6");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 6-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/6.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic6::resizeEvent(QResizeEvent *evt)
{
...
void Grafic6::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic6::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic6::on_pushButton_3_clicked()
{
...
void Grafic6::on_pushButton_4_clicked()
{
