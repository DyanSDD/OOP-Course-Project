...
Grafic2::Grafic2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Grafic2)
{
    ui->setupUi(this);

    this->setWindowTitle("Modelarea 2");
    ...
    videoLocation += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/2D/Grafic 2-2D.png";
    videoLocation2 += "/Proiect-6-echipa-2-grupa-322AC/Data/graph/text/2.png";
    char* charVLocation;
    char* charVLocation2;
...
void Grafic2::resizeEvent(QResizeEvent *evt)
{
...
void Grafic2::on_pushButton_clicked()
{
    hide();
    parentWidget()->show();
}

void Grafic2::on_pushButton_2_clicked()
{
    parentWidget()->~QWidget();
}

void Grafic2::on_pushButton_3_clicked()
{
...
void Grafic2::on_pushButton_4_clicked()
{
