/****************************************************************************
** Meta object code from reading C++ file 'grafice.h'
**
...
#include <memory>
#include "../../ProiectPOO/grafice.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'grafice.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_Grafice_t {
    QByteArrayData data[16];
    char stringdata0[348];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Grafice_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Grafice_t qt_meta_stringdata_Grafice = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Grafice"
...
QT_MOC_LITERAL(15, 323, 24) // "on_pushButton_14_clicked"

    },
    "Grafice\0on_pushButton_clicked\0\0"
...
static const uint qt_meta_data_Grafice[] = {
...
void Grafice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Grafice *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Grafice::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Grafice.data,
    qt_meta_data_Grafice,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *Grafice::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Grafice::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Grafice.stringdata0))
        return static_cast<void*>(this);
    return QMainWindow::qt_metacast(_clname);
}

int Grafice::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
